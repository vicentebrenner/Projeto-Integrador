...
public class VagaController {
    ...
    public ResponseEntity<Vaga> criarVaga(@PathVariable Long bandaId, @RequestBody VagaRequestDTO dto) {
        return ResponseEntity.ok(vagaService.criarVaga(bandaId, dto));
    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Vaga> atualizarVaga(@PathVariable Long id, @RequestBody VagaRequestDTO dto) {
        return ResponseEntity.ok(vagaService.atualizarVaga(id, dto));
    }
